...
Original file is located at
    https://colab.research.google.com/github/heqiaow/Curso2025-2026-ODKG/blob/master/Assignment4/course_materials/notebooks/Task06.ipynb
...
# ----- Define the classes as in the slide -----
...
g.add((person.Oscar, foaf.email, Literal("oscar@upm.es", datatype=XSD.string)))
